...
/*!
 * @brief This class represents the TopicDataType of the type Shape defined by the user in the IDL file.
 * @ingroup shape
 */
class ShapePubSubType : public eprosima::fastdds::dds::TopicDataType
{
public:

    typedef Shape type;

    eProsima_user_DllExport ShapePubSubType();

    eProsima_user_DllExport ~ShapePubSubType() override;
