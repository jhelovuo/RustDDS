...
impl ProtocolVersion_t {
    pub const PROTOCOLVERSION: ProtocolVersion_t = ProtocolVersion_t::PROTOCOLVERSION_2_2;
    ...
    pub const PROTOCOLVERSION_2_3: ProtocolVersion_t = ProtocolVersion_t { major: 2, minor: 3 };
}
...
mod tests {
    ...
    {
        protocol_version_2_3,
        ProtocolVersion_t::PROTOCOLVERSION_2_3,
        le = [0x02, 0x03],
        be = [0x02, 0x03]
    });
}
