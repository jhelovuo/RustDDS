...
mod tests {
    ...
    fn submessage_data_submessage_deserialization() {
        ...
        let serialized_data_submessage = Bytes::from_static(&[
            0x15, 0x05, 0x2c, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00,
            0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x5b, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,
            0x04, 0x00, 0x00, 0x00, 0x52, 0x45, 0x44, 0x00, 0x69, 0x00, 0x00, 0x00, 0x17, 0x00,
    ...
    fn submessage_hearbeat_deserialization() {
        let serialized_heartbeat_message: Vec<u8> = vec![
            0x07, 0x01, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x01, 0x02, 0x00, 0x00,
            0x00, 0x00, 0x5b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x5b, 0x00, 0x00, 0x00,
            0x1f, 0x00, 0x00, 0x00,
        ];
    ...
    fn submessage_info_dst_deserialization() {
        let serialized_info_dst_message: Vec<u8> = vec![
            0x0e, 0x01, 0x0c, 0x00, 0x01, 0x03, 0x00, 0x0c, 0x29, 0x2d, 0x31, 0xa2, 0x28, 0x20,
            0x02, 0x08,
        ];
    ...
    //     0x09, 0x01, 0x08, 0x00, 0x1a, 0x15, 0xf3, 0x5e, 0x00, 0xcc, 0xfb,
    // 0x13,   ];
    //   let header =
