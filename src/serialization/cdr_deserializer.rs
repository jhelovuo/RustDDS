...
pub struct CdrDeserializer<'de, BO> {
    phantom: PhantomData<BO>, /* This field exists only to provide use for BO. See PhantomData
                               * docs. */
    ...
    BO: ByteOrder,
{
    ...
    /// The numeric values associated with enum identifiers are determined by
    /// the order in which the identifiers appear in the enum declaration.
    /// The first enum identifier has the numeric value zero (0). Successive
    /// enum identifiers take ascending numeric values, in order of
    ...
    /// or the variant of an enum. In JSON, struct fields and enum variants
    /// are represented as strings. In other formats they may be represented
    /// as numeric indices.
...
mod tests {
    ...
    fn cdr_deserialization_struct() {
        ...
        */
        ...
        let expected_serialized_result: Vec<u8> = vec![
            0x01, 0xfd, 0x00, 0x00, 0x78, 0xec, 0xff, 0xff, 0xd2, 0x04, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x33, 0x33, 0xd3, 0xc0, 0x01, 0x00, 0x00, 0x00,
            0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00,
            0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x05, 0x00, 0xfc, 0xff,
            0x03, 0x00, 0xfe, 0xff, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x00,
            0x02, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x61, 0x62, 0x63, 0x00,
        ];
    ...
    fn cdr_deserialization_user_defined_data() {
        ...
        let expected_serialized_result: Vec<u8> = vec![
            0x05, 0x00, 0x00, 0x00, 0x42, 0x4c, 0x55, 0x45, 0x00, 0x00, 0x00, 0x00, 0x22, 0x00,
            0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00,
        ];
    ...
    fn cdr_deserialization_serialization_payload_shapes() {
        ...
        let received_message: Vec<u8> = vec![
            0x04, 0x00, 0x00, 0x00, 0x52, 0x45, 0x44, 0x00, 0x61, 0x00, 0x00, 0x00, 0x1b, 0x00,
        ...
        let serialized_message =
            to_bytes::<ShapeType, LittleEndian>(&deserialized_message).unwrap();
    ...
    fn cdr_deserialization_custom_data_message_from_ros_and_wireshark() {
        ...
        let received_message_le: Vec<u8> = vec![
            ...
            0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f, 0x85,
            0xeb, 0x51, 0xb8, 0x1e, 0xd5, 0x3f, 0x0a, 0x00, 0x00, 0x00, 0x54, 0x6f, 0x69, 0x6d,
            0x69, 0x69, 0x6b, 0x6f, 0x3f, 0x00, //0x00, 0x00,
        ];
    ...
    fn cdr_deserialization_custom_type() {
        ...
        */
        ...
        const DATA: &[u8] = &[
            0x1b, 0x00, 0x00, 0x00, 0x54, 0x61, 0x73, 0x73, 0x61, 0x20, 0x6f, 0x6e, 0x20, 0x61,
            0x69, 0x6b, 0x61, 0x20, 0x70, 0x69, 0x74, 0x6b, 0x61, 0x20, 0x74, 0x65, 0x6b, 0x73,
            0x74, 0x69, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0xfd, 0xff, 0xff, 0xff, 0xfc, 0xff,
            0xff, 0xff, 0x00, 0x00, 0xb0, 0x40, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x1a, 0xc0,
            0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x01, 0x00, 0xfe, 0xff, 0xfd, 0xff, 0x04, 0x00,
            0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00,
            0x17, 0x00, 0x02,
        ];
        ...
        info!("serialization success!");
        let deserialization_result: InterestingMessage =
            deserialize_from_little_endian(DATA).unwrap();
