    ...
    W: io::Write,
{
    ...
    fn serialize_str(self, v: &str) -> Result<()> {
        ...
        Ok(())
        // The end result is not UTF-8-encoded string, but how could we do
        // better in CDR?
    }
...
mod tests {
    ...
    fn cdr_serialization_example() {
        ...
        let expected_serialization_le: Vec<u8> =
            vec![0x01, 0x00, 0x00, 0x00, 0x61, 0x62, 0x63, 0x64];

        let expected_serialization_be: Vec<u8> =
    ...
    fn cdr_serialization_test() {
        ...
        let expected: Vec<u8> = vec![
            0x01, 0xff, 0x00, 0x00, 0x17, 0x00, 0x00, 0x00, 0x67, 0x67, 0x34, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x01,
        ];
    ...
    fn cdr_serialize_seq() {
        ...
        let sarjallistettu = to_little_endian_binary(&mikki_hiiri).unwrap();
        let expected: Vec<u8> = vec![
            0x0b, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00,
            0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x07, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x09, 0x00, 0x00, 0x00, 0x0a, 0x00,
            0x00, 0x00, 0xf3, 0xe0, 0x01, 0x00,
        ];
        assert_eq!(expected, sarjallistettu)
    }
}
