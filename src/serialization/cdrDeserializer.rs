...
fn CDR_Deserialization_example_struct(){
  ...
  struct example {
    ...
    let mut serialized_le: Vec<u8>= vec![
      0x01, 0x00, 0x00, 0x00,
      0x61, 0x62, 0x63, 0x64,
    ];

    let mut serialized_be: Vec<u8> = vec![
      0x00, 0x00, 0x00, 0x01,
      0x61, 0x62, 0x63, 0x64,
    ];
    ...
    assert_eq!(serializedO_le,vec![
      0x01, 0x00, 0x00, 0x00,
      0x61, 0x62, 0x63, 0x64,
    ]);

    assert_eq!(serializedO_be,vec![
      0x00, 0x00, 0x00, 0x01,
      0x61, 0x62, 0x63, 0x64,
    ]);
...
fn CDR_Deserialization_custom_data_message_from_ROS_and_wireshark(){
  ...
  let mut recieved_message_le: Vec<u8> = vec![
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40,  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  0x1f, 0x85, 0xeb, 0x51, 0xb8, 0x1e, 0xd5, 0x3f,
    0x0a, 0x00, 0x00, 0x00, 0x54, 0x6f, 0x69, 0x6d,  0x69, 0x69, 0x6b, 0x6f, 0x3f, 0x00, 0x00, 0x00
  ];
