...
pub type RosSubscriber<'a, D, DA> = Box<dyn crate::dds::IDataReader<D, DA> + 'a>;

/// KeyedRosSubscriber wrapper for slightly inconvenient boxed type
pub type KeyedRosSubscriber<'a, D, DA> = Box<dyn crate::dds::IKeyedDataReader<D, DA> + 'a>;

/// RosPublisher wrapper for slightly inconvenient boxed type
pub type RosPublisher<'a, D, SA> = Box<dyn crate::dds::IDataWriter<D, SA> + 'a>;

/// KeyedRosPublisher wrapper for slightly inconvenient boxed type
pub type KeyedRosPublisher<'a, D, SA> = Box<dyn crate::dds::IKeyedDataWriter<D, SA> + 'a>;
