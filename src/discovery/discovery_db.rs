...
impl DiscoveryDB {
    ...
    pub fn update_participant(&mut self, data: &SpdpDiscoveredParticipantData) -> bool {
        ...
        self.participant_last_life_signs
...
mod tests {
    ...
    use crate::{
        ...
        test::{
            ...
            test_data::{
                reader_proxy_data, spdp_participant_data, subscription_builtin_topic_data,
            },
        },
    };
