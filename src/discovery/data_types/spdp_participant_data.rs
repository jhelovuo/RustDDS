...
mod tests {
    ...
    use crate::{
        ...
        serialization::{
            cdr_serializer::to_bytes, message::Message,
            pl_cdr_deserializer::PlCdrDeserializerAdapter, submessage::*,
        },
        test::test_data::*,
    };
                ...
                SubmessageBody::Entity(v) => match v {
                    EntitySubmessage::Data(d, _) => {
                        let participant_data: SpdpDiscoveredParticipantData =
                            ...
                            .unwrap();
                        let sdata = to_bytes::<SpdpDiscoveredParticipantData, LittleEndian>(
                            &participant_data,
                        )
                        .unwrap();
                        ...
                        let _sdata_2 = to_bytes::<SpdpDiscoveredParticipantData, LittleEndian>(
                            &participant_data_2,
                        )
                        .unwrap();
