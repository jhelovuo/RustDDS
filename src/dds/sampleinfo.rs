...
/// It exists only at the receiving end of DDS, and is (mostly) generated by DDS.
///
/// Some of the SampleInfo field description texts are quoted from the DDS Specification. 
#[derive(Debug, Clone, PartialEq)]
pub struct SampleInfo {
  /// sample_state indicates whether or not the corresponding data sample has already
  /// been read through this DataReader.
