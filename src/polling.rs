...
// 
// Then we cold implement them either on top of mio-0.6, mio-0.8 or something else
...
// Additionally, each timer creates its own background thread, which also takes up resources,
// but changing that would be a major change.
