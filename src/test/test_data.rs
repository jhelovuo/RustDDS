...
pub(crate) fn spdp_subscription_data_raw() -> Bytes {
    const DATA: [u8; 248] = [
        ...
        ,
...
use crate::{
    dds::{
        qos::{
            policy::{
                ...
                Liveliness, Ownership, Presentation, PresentationAccessScope, Reliability,
                ResourceLimits, TimeBasedFilter,
            },
            QosPolicyBuilder,
        },
    ...
    messages::{
        header::Header,
        submessages::{
            submessage_elements::serialized_payload::{
        ...
        match &mut submsg.body {
            SubmessageBody::Entity(v) => match v {
                EntitySubmessage::Data(d, _) => {
                    ...
                    data = Bytes::from(
                        to_bytes::<SpdpDiscoveredParticipantData, byteorder::LittleEndian>(
                            &participant_data,
                        )
                        .unwrap(),
                    );
                    ...
                    submsglen = submsglen
                        + d.serialized_payload.as_ref().unwrap().value.len() as u16
                        - datalen;
                }
                _ => continue,
            },
